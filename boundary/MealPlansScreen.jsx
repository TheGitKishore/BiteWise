    ...
    >
      <ScrollView keyboardShouldPersistTaps="handled"
        ...
        <View style={ea.contextRow}>
          <View style={ea.autoBadge}><View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/stat-calories-burned.png')} style={{width:20,height:20,resizeMode:'contain'}} /><Text style={ea.autoBadgeTxt}>Auto-Generated</Text></View></View>
  ...
  <View style={mc.card}>
    <View style={mc.titleRow}>
      ...
      {plan.isAutoGenerated && (
        <View style={mc.autoBadge}><View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/stat-calories-burned.png')} style={{width:20,height:20,resizeMode:'contain'}} /><Text style={mc.autoBadgeText}>Auto</Text></View></View>
      )}
    </View>
    {plan.description ? <Text style={mc.desc}>{plan.description}</Text> : null}
    <View style={mc.metaRow}>
      <View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/empty-meal-plans.png')} style={{width:48,height:48,resizeMode:'contain'}} /><Text style={mc.meta}>{plan.numDays} days</Text></View>
    ...
    <View style={mc.actionRow}>
      ...
      {isPremium && (
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/icon-edit.png')} style={{width:13,height:13,resizeMode:'contain'}} /><Text style={mc.editBtnText}>Edit</Text></View>
        </TouchableOpacity>
      )}
      <TouchableOpacity style={mc.deleteBtn} onPress={() => onDelete(plan.planId)} activeOpacity={0.8}>
        <View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/icon-delete.png')} style={{width:18,height:18,resizeMode:'contain'}} /><Text style={mc.deleteBtnText}>Delete</Text></View>
      </TouchableOpacity>
    </View>
  </View>
);
      ...
      <ScrollView contentContainerStyle={styles.list} showsVerticalScrollIndicator={false}
        ...
        <View style={styles.actionRow}>
          <TouchableOpacity style={styles.autoBtn} onPress={() => setShowGenerate(true)} activeOpacity={0.85}>
            <Image source={require('../assets/stat-calories-burned.png')} style={[styles.autoIcon,{width:20,height:20,resizeMode:'contain'}]} />
        ...
        {isLoading ? (
          ...
          <View style={styles.emptyState}>
            <Image source={require('../assets/empty-meal-plans.png')} style={[styles.emptyIcon,{width:48,height:48,resizeMode:'contain'}]} />
