    ...
    >
      <ScrollView keyboardShouldPersistTaps="handled"
        ...
        <View style={ea.contextRow}>
          <View style={ea.autoBadge}><View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/stat-calories-burned.png')} style={{width:20,height:20,resizeMode:'contain'}} /><Text style={ea.autoBadgeTxt}>Auto-Generated</Text></View>
  ...
  <View style={mc.card}>
    <View style={mc.titleRow}>
      ...
      {plan.isAutoGenerated && (
        <View style={mc.autoBadge}><View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/stat-calories-burned.png')} style={{width:20,height:20,resizeMode:'contain'}} /><Text style={mc.autoBadgeText}>Auto</Text></View>
      )}
    </View>
    {plan.description ? <Text style={mc.desc}>{plan.description}</Text> : null}
    <View style={mc.metaRow}>
      <View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/empty-meal-plans.png')} style={{width:48,height:48,resizeMode:'contain'}} /><Text style={mc.meta}>{plan.numDays} days</Text>
    ...
    <View style={mc.actionRow}>
      ...
      <TouchableOpacity style={mc.deleteBtn} onPress={() => onDelete(plan.planId)} activeOpacity={0.8}>
        <View style={{flexDirection:'row',alignItems:'center',gap:4}}><Image source={require('../assets/icon-delete.png')} style={{width:18,height:18,resizeMode:'contain'}} /><Text style={mc.deleteBtnText}>Delete</Text>
      </TouchableOpacity>
    </View>
  </View>
);
