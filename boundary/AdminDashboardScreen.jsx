...
const c = StyleSheet.create({
  ...
  row:             { backgroundColor: C.white, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: C.border, marginBottom: 10, flexDirection: 'row', alignItems: 'center' },
  ...
  appActions:      { alignItems: 'flex-end' },
